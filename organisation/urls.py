...
urlpatterns = [
    ...
    path('organisations', views.create_new_organisation , name="create_new_organisation"),
    path('organisations/<str:orgId>/', views.get_an_organisation_by_id, name="get_an_organisation_by_id"),
    path('organisations/<str:orgId>/users', views.add_user_to_an_organisation, name="add_user_to_organisation"),
]
